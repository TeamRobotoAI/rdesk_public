...
[![Version](https://img.shields.io/badge/Version-1.0.1-blue.svg?style=for-the-badge&logo=flutter)](https://rdesk.robotoai.com)
...
## 📦 Download & Releases (Version 1.0.1)
...
|:---|:---|:---|:---|
| **Windows (x64)** | `r_desk_1.0.1_x64_setup.exe` | Standard 64-bit installer for Windows 10 & 11 PCs. | [Download x64](./windows/stable/version/1.0.1/r_desk_1.0.1_x64_setup.exe) |
| **Windows (ARM64)**| `r_desk_1.0.1_arm64_setup.exe` | Optimized native installer for Windows on ARM (Snapdragon X Elite, Surface Pro 9/11). | [Download ARM64](./windows/stable/version/1.0.1/r_desk_1.0.1_arm64_setup.exe) |
...
1. Download the appropriate setup file (`r_desk_1.0.1_x64_setup.exe` or `r_desk_1.0.1_arm64_setup.exe`).
...
└── windows/stable/version/1.0.1/ # Windows distribution installers
    ├── r_desk_1.0.1_x64_setup.exe
    └── r_desk_1.0.1_arm64_setup.exe
```
